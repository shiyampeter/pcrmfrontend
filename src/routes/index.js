...
const RegisterSuccessClassic = React.lazy(() => import('../views/auth/classic/RegisterSuccessClassic'));
...
const RegisterSuccessCreative = React.lazy(() => import('../views/auth/creative/RegisterSuccessCreative'));
const ResetPasswordCreative = React.lazy(() => import('../views/auth/creative/ResetPasswordCreative'));
const ForgotPasswordCreative = React.lazy(() => import('../views/auth/creative/ForgotPasswordCreative'));
...
const RegisterSuccessCorporate = React.lazy(() => import('../views/auth/corporate/RegisterSuccessCorporate'));
const ResetPasswordCorporate = React.lazy(() => import('../views/auth/corporate/ResetPasswordCorporate'));
const ForgotPasswordCorporate = React.lazy(() => import('../views/auth/corporate/ForgotPasswordCorporate'));
const TwoFactorOTPCorporate = React.lazy(() => import('../views/auth/corporate/TwoFactorOTPCorporate'));
...
// Email Templates
const EmailTemplateConfirmAccount = React.lazy(() => import('../views/etemplates/EmailTemplateConfirmAccount'));
const EmailTemplateExpiredCard = React.lazy(() => import('../views/etemplates/EmailTemplateExpiredCard'));
const EmailTemplateResetPassword = React.lazy(() => import('../views/etemplates/EmailTemplateResetPassword'));
const EmailTemplateWelcomeMessage = React.lazy(() => import('../views/etemplates/EmailTemplateWelcomeMessage'));
const EmailTemplateCouponSale = React.lazy(() => import('../views/etemplates/EmailTemplateCouponSale'));
const EmailTemplateLatestUpdate = React.lazy(() => import('../views/etemplates/EmailTemplateLatestUpdate'));
// Dashboards
    ...
    children: [
        {
            ...
            name: 'Root',
            element: _jsx(Ecommerce, {}),
            route: PrivateRoute,
        },
        {
            path: '/dashboards/analytics',
            name: 'Analytics',
            element: _jsx(Analytics, {}),
            route: PrivateRoute,
        },
        {
            path: '/dashboards/crm',
...
const masterRoutes = {
    ...
    children: [
        ...
        // },
        {
            ...
            name: 'WorkCategory',
            element: _jsx(WorkCategory, {}),
            route: PrivateRoute,
        },
        {
            path: '/master/work-subcategory',
            name: 'WorkSubCategory',
            element: _jsx(WorkSubCategory, {}),
            route: PrivateRoute,
        },
        {
            path: '/master/work-status',
            name: 'WorkStatus',
            element: _jsx(WorkStatus, {}),
            route: PrivateRoute,
        },
    ],
};
        ...
        children: [
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        name: 'Login',
                        element: _jsx(LoginClassic, {}),
                        route: Route,
                    },
                    {
                        path: '/auth/creative/login',
                        name: 'Login',
                        element: _jsx(LoginCreative, {}),
                        route: Route,
                    },
                    {
                        path: '/auth/corporate/login',
                        name: 'Login',
                        element: _jsx(LoginCorporate, {}),
                        route: Route,
                    },
                    {
                        path: '/auth/modern/login',
                        name: 'Login',
                        element: _jsx(LoginModern, {}),
                        route: Route,
                    },
                ],
            },
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        name: 'Register',
                        element: _jsx(RegisterClassic, {}),
                        route: Route,
                    },
                    {
                        path: '/auth/creative/register',
                        name: 'Register',
                        element: _jsx(RegisterCreative, {}),
                        route: Route,
                    },
                    {
                        path: '/auth/corporate/register',
                        name: 'Register',
                        element: _jsx(RegisterCorporate, {}),
                        route: Route,
                    },
                    {
                        path: '/auth/modern/register',
                        name: 'Register',
                        element: _jsx(RegisterModern, {}),
                        route: Route,
                    },
                ],
            },
                ...
                children: [
                    {
                        ...
                        name: 'Register Success',
                        element: _jsx(RegisterSuccess, {}),
                        route: Route,
                    },
                    {
                        path: '/auth/classic/register-success',
                        name: 'Register Success',
                        element: _jsx(RegisterSuccessClassic, {}),
                        route: Route,
                    },
                    {
                        path: '/auth/creative/register-success',
                        name: 'Register Success',
                        element: _jsx(RegisterSuccessCreative, {}),
                        route: Route,
                    },
                    {
                        path: '/auth/corporate/register-success',
                        name: 'Register Success',
                        element: _jsx(RegisterSuccessCorporate, {}),
                        route: Route,
                    },
                    {
                        path: '/auth/modern/register-success',
                        name: 'Register Success',
                        element: _jsx(RegisterSuccessModern, {}),
                        route: Route,
                    },
                ],
            },
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        name: 'Reset Password',
                        element: _jsx(ResetPasswordClassic, {}),
                        route: Route,
                    },
                    {
                        path: '/auth/creative/reset-password',
                        name: 'Reset Password',
                        element: _jsx(ResetPasswordCreative, {}),
                        route: Route,
                    },
                    {
                        path: '/auth/corporate/reset-password',
                        name: 'Reset Password',
                        element: _jsx(ResetPasswordCorporate, {}),
                        route: Route,
                    },
                    {
                        path: '/auth/modern/reset-password',
                        name: 'Reset Password',
                        element: _jsx(ResetPasswordModern, {}),
                        route: Route,
                    },
                ],
            },
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        name: 'Forgot Password',
                        element: _jsx(ForgotPasswordClassic, {}),
                        route: Route,
                    },
                    {
                        path: '/auth/creative/forgot-password',
                        name: 'Forgot Password',
                        element: _jsx(ForgotPasswordCreative, {}),
                        route: Route,
                    },
                    {
                        path: '/auth/corporate/forgot-password',
                        name: 'Forgot Password',
                        element: _jsx(ForgotPasswordCorporate, {}),
                        route: Route,
                    },
                    {
                        path: '/auth/modern/forgot-password',
                        name: 'Forgot Password',
                        element: _jsx(ForgotPasswordModern, {}),
                        route: Route,
                    },
                ],
            },
                ...
                children: [
                    {
                        ...
                        name: 'Two-facafor (OTP)',
                        element: _jsx(TwoFactorOTP, {}),
                        route: Route,
                    },
                    {
                        path: '/auth/classic/otp',
                        name: 'Two-facafor (OTP)',
                        element: _jsx(TwoFactorOTPClassic, {}),
                        route: Route,
                    },
                    {
                        path: '/auth/creative/otp',
                        name: 'Two-facafor (OTP)',
                        element: _jsx(TwoFactorOTPCreative, {}),
                        route: Route,
                    },
                    {
                        path: '/auth/corporate/otp',
                        name: 'Two-facafor (OTP)',
                        element: _jsx(TwoFactorOTPCorporate, {}),
                        route: Route,
                    },
                    {
                        path: '/auth/modern/otp',
                        name: 'Two-facafor (OTP)',
                        element: _jsx(TwoFactorOTPModern, {}),
                        route: Route,
                    },
                ],
            },
                ...
                children: [
                    {
                        ...
                        name: 'Lock Screen',
                        element: _jsx(LockScreen, {}),
                        route: Route,
                    },
                    {
                        path: '/auth/classic/lock-screen',
                        name: 'Lock Screen',
                        element: _jsx(LockScreenClassic, {}),
                        route: Route,
                    },
                    {
                        path: '/auth/creative/lock-screen',
                        name: 'Lock Screen',
                        element: _jsx(LockScreenCreative, {}),
                        route: Route,
                    },
                    {
                        path: '/auth/corporate/lock-screen',
                        name: 'Lock Screen',
                        element: _jsx(LockScreenCorporate, {}),
                        route: Route,
                    },
                    {
                        path: '/auth/modern/lock-screen',
                        name: 'Lock Screen',
                        element: _jsx(LockScreenModern, {}),
                        route: Route,
                    },
                ],
            },
...
const errorRoutes = [
    ...
    },
    {
        ...
        name: 'Server Error',
        element: _jsx(ServerError, {}),
        route: Route,
    },
    {
        path: '/error-pages/not-authorized',
        name: 'Not Authorized',
        element: _jsx(NotAuthorized, {}),
        route: Route,
    },
    {
