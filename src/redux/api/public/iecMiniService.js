...
export const iecMiniAdd = createAsyncThunk('iecMiniAdd', async (params, thunkAPI) => {
    try {
...
export const iecMiniEdit = createAsyncThunk('iecMiniEdit', async (params, thunkAPI) => {
    try {
...
export const iecMiniAddOnline = createAsyncThunk('iecMiniAddOnline', async (params, thunkAPI) => {
    try {
...
export const iecMiniEditOnline = createAsyncThunk('iecMiniOnline', async (params, thunkAPI) => {
    try {
...
export const iecMiniView = createAsyncThunk('iecMiniView', async (id, thunkAPI) => {
    try {
...
export const iecMiniDelete = createAsyncThunk('iecMiniDelete', async (id, thunkAPI) => {
    try {
