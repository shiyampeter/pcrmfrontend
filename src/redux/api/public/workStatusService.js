...
export const workStatusAdd = createAsyncThunk('workStatusAdd', async (params, thunkAPI) => {
    try {
...
export const workStatusEdit = createAsyncThunk('workStatusEdit', async (params, thunkAPI) => {
    try {
...
export const workStatusView = createAsyncThunk('workStatusView', async (id, thunkAPI) => {
    try {
...
export const workStatusDelete = createAsyncThunk('workStatusDelete', async (id, thunkAPI) => {
    try {
