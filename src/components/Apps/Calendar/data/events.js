...
export const events = [
    {
        ...
        description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aperiam culpa, fuga eius, repellendus velit nesciunt consequatur nulla corrupti delectus quia animi ipsam quibusdam sapiente tempora ipsa error quisquam. Ipsam, dolores!',
    },
    {
        id: 'default-event-id-' + Math.floor(Math.random() * 9999999),
