...
const EmailHeader = ({ selectedCategory, labels, categories, sidebarMiniToggle, setSidebarMiniToggle }) => {
    ...
    return (_jsxs(Stack, { direction: "horizontal", gap: 4, className: "px-3 border-bottom", style: { minHeight: '4.5rem' }, children: [_jsxs(Stack, { direction: "horizontal", gap: 2, children: [_jsx(Button, { variant: "light", className: "btn-icon btn-md", onClick: handleSidebarMiniToggle, children: _jsx("i", { className: "fi fi-rr-menu-burger" }) }), _jsx("h5", { className: "fs-16 fw-bold mb-0", children: labels.find((label) => label.value === selectedCategory)?.name ??
