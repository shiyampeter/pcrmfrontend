export const notifyData = [
    {
        id: 1,
        title: 'Congratulate <span class="fw-semibold text-dark">Socrates Itumay</span> for work anniversaries',
    ...
    {
        id: 3,
        title: '<span class="fw-semibold text-dark">Adrian Monino</span> added new comment on your photo',
        icon: 'fi fi-rr-heart',
        variant: 'danger',
