const dataPrivacy = [
    ...
    {
        title: 'Use, Sharing or Disclosing of Personal Information',
    ...
    },
    {
        ...
        desc: `<p>Cookies are used by us occasionally. In their nature Cookies are small text files that can be used by a web site to identify/recognize a repeat visitor to the web site. Cookies may be used by us for variable reasons, including:</p>
        <ul>
