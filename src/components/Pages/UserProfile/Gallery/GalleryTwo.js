...
const GalleryTwo = () => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("style", { children: `
        ...
        ` }), _jsxs(Card, { children: [_jsxs(Card.Header, { className: "py-3 pe-3 d-flex justify-content-between align-items-center", children: [_jsx(Card.Title, { children: "Personal albums" }), _jsx("div", { className: "ms-auto", children: _jsxs(Dropdown, { align: 'end', className: "flex-shrink-0 ms-2", children: [_jsx(Dropdown.Toggle, { variant: "soft-light", size: "sm", className: "rounded-pill", children: "Action" }), _jsxs(Dropdown.Menu, { children: [_jsx(Dropdown.Item, { href: "#!", children: "Invite" }), _jsx(Dropdown.Item, { href: "#!", children: "Rename" }), _jsx(Dropdown.Item, { href: "#!", children: "View Details" }), _jsx(Dropdown.Item, { href: "#!", children: "Add to Favorite" }), _jsx(Dropdown.Divider, {}), _jsx(Dropdown.Item, { href: "#!", className: "text-danger", children: "Delete" })] })] }) })] }), _jsxs(Card.Body, { children: [_jsx(PhotoAlbum, { photos: dataGalleryTwo, layout: "masonry", targetRowHeight: 200, onClick: ({ index }) => setIndex(index) }), _jsx(Lightbox, { slides: dataGalleryTwo, open: index >= 0, index: index, close: () => setIndex(-1), plugins: [Fullscreen, Slideshow, Thumbnails, Zoom, Download, Captions, Counter, Share] })] }), _jsx(Card.Footer, { children: _jsxs(Stack, { direction: "horizontal", gap: 2, children: [_jsx("span", { className: "fs-13 text-muted", children: "46 Photos" }), _jsx("span", { className: "d-none d-lg-flex bg-secondary bg-opacity-50 rounded-circle", style: { width: '0.25rem', height: '0.25rem' } }), _jsx("span", { className: "fs-13 text-muted", children: "22 Aug, 2024" })] }) })] })] }));
};
