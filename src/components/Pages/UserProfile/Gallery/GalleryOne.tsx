    ...
    <>
      ...
      <Card>
        <Card.Header className="py-3 pe-3 d-flex justify-content-between align-items-center">
          <Card.Title>Project albums</Card.Title>
        ...
        <Card.Body>
          <PhotoAlbum
            photos={dataGalleryOne}
            layout="masonry"
            targetRowHeight={200}
            onClick={({ index }) => setIndex(index)}
          />
          <Lightbox
            slides={dataGalleryOne}
            open={index >= 0}
            index={index}
            close={() => setIndex(-1)}
