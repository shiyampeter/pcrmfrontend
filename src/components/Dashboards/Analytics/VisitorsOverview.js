...
const VisitorsOverview = () => {
    ...
    return (_jsx(_Fragment, { children: _jsxs(Card, { children: [_jsxs(Card.Header, { className: "d-sm-flex align-items-center py-3", children: [_jsx(Card.Title, { children: "Visitors Overview" }), _jsx("div", { className: "ms-auto mt-3 mt-sm-0", style: { width: '160px' }, children: _jsx(Select, { value: selectedOption, onChange: handleChange, options: options, isClearable: false, classNamePrefix: "select" }) })] }), _jsx(Card.Body, { children: _jsx(ReactApexChart, { options: apexOptions, series: [...getChartData()], type: "bar", height: 345 }) })] }) }));
};
