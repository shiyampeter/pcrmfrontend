...
export default function useThemeCustomizer() {
    ...
    const handleChangeColorScheme = (color) => {
        switch (color) {
            case 'success':
    ...
    const handleChangeNavigationType = (type) => {
        switch (type) {
            case 'horizontal':
    ...
    const handleChangeContentLayout = (width) => {
        switch (width) {
            case 'fluid':
    ...
    const handleChangeSkinMode = (theme) => {
        switch (theme) {
            case 'dark':
    ...
    const handleChangeSidenavType = (type) => {
        switch (type) {
            case 'fullscreen':
    ...
    const handleChangeNavigationSkin = (theme) => {
        switch (theme) {
            case 'light':
    ...
    const handleChangeNavigationMenu = (menu) => {
        switch (menu) {
            case 'soft':
    ...
    const handleChangeHeaderSkin = (value) => {
        switch (value) {
            case 'dark':
    ...
    const handleChangeContentSkin = (position) => {
        switch (position) {
            case 'default':
                updateLayout({
    ...
    const handleChangeThemeFont = (font) => {
        switch (font) {
            case 'inter':
