...
export default function MuiSelectField({ option = [], id = '', renderOption = () => { } }) {
    ...
    return (_jsxs("form", { onSubmit: handleSubmit(onSubmit), children: [_jsx(Autocomplete, { className: "select", multiple: true, limitTags: 2, ...register('name'), options: top100Films, renderOption: (props, option, { selected }) => (_jsxs("li", { ...props, children: [_jsx(Checkbox, { icon: icon, checkedIcon: checkedIcon, style: { marginRight: 8 }, checked: selected }), option.title] })), getOptionLabel: (option) => option.title, defaultValue: [top100Films[13], top100Films[12], top100Films[11]], renderInput: (params) => (_jsx(TextField, { size: "small", ...params, error: !!errors?.name, helperText: errors?.name?.message })) }), _jsx(MuiRadioGroup, { radios: [
                    {
                        value: 'daily',
                        label: 'Daily',
                    },
                ...
                ] }), _jsx("button", { type: "submit", children: "Sunmm0" })] }));
}
