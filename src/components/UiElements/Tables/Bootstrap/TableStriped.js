...
function TableStriped() {
    return (_jsxs(Table, { responsive: true, striped: true, className: "mb-0", children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "#ID" }), _jsx("th", { children: "Sale Rep." }), _jsx("th", { children: "Status" }), _jsx("th", { children: "Date & Time" }), _jsx("th", { className: "text-end", children: "Actions" })] }) }), _jsx("tbody", { children: (tableData || []).map((data, idx) => {
