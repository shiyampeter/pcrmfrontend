...
const SweetAlert2Basic = () => {
    ...
    return (_jsx(_Fragment, { children: _jsx(Stack, { direction: "horizontal", gap: 1, className: "flex-wrap", children: sweetAlertData.map((item, index) => (_jsx(Button, { variant: "primary", onClick: item.onClick, children: item.label }, index))) }) }));
};
