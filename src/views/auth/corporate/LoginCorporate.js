...
const LoginCorporate = () => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(TitleHelmet, { title: "Login Corporate" }), _jsx(AuthLayout, { children: _jsxs(AuthCorporate, { children: [isAuthenticated && _jsx(Navigate, { to: redirectUrl, replace: true }), _jsxs("div", { className: "mb-12", children: [_jsx("h4", { className: "fw-bold mb-3", children: "Login to your account" }), _jsx("p", { className: "fs-16 lead", children: "Hey, Enter your details to get login to your account." })] }), _jsxs(Form, { onSubmit: handleSubmit, children: [_jsxs(Form.Group, { className: "mb-3", children: [_jsx(Form.Control, { type: "email", placeholder: "Email", value: email, onChange: (e) => {
